...
- (void)buildView {
    ...
    // 基站信息
    self.baseLabel               = [[UILabel alloc] initWithFrame:CGRectMake(0, 5, ScreenWidth - 8, 12.f)];
    ...
    if (iPhone4_4s || iPhone5_5s) {
        redViewWidth = 100;
        self.redView = [[UIView alloc] initWithFrame:CGRectMake(ScreenWidth - redViewWidth, 22, redViewWidth + 100, 44)];
    } else if (iPhone6) {
        redViewWidth = 135;
        self.redView = [[UIView alloc] initWithFrame:CGRectMake(ScreenWidth - redViewWidth, 22, redViewWidth + 100, 60)];
    } else if (iPhone6_plus) {
        redViewWidth = 135;
        self.redView = [[UIView alloc] initWithFrame:CGRectMake(ScreenWidth - redViewWidth, 22, redViewWidth + 100, 60)];
    } else {
    ...
    if (iPhone4_4s || iPhone5_5s) {
        ...
        self.updateYearLabel      = [[UILabel alloc] initWithFrame:CGRectMake(0, 30, ScreenWidth - 40, 12.f)];
        ...
        self.updateYearLabel      = [[UILabel alloc] initWithFrame:CGRectMake(0, 30, ScreenWidth - 40, 18)];
        self.updateYearLabel.text = @"2015.03.21";
        self.updateYearLabel.textAlignment = NSTextAlignmentRight;
        self.updateYearLabel.textColor = [UIColor whiteColor];
    ...
    if (iPhone4_4s || iPhone5_5s) {
        ...
        self.updateHourLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 45, ScreenWidth - 8, 14.f)];
        ...
        self.updateHourLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 55, ScreenWidth - 8, 20.f)];
        self.updateHourLabel.textAlignment = NSTextAlignmentRight;
        self.updateHourLabel.text = @"13:20 update";
        self.updateHourLabel.textColor = [UIColor whiteColor];
    ...
    if (iPhone4_4s || iPhone5_5s) {
        ...
        self.cityNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(12, 16, ScreenWidth - 10, 40)];
        self.cityNameLabel.text = @"San Francisco";
        self.cityNameLabel.font = [UIFont fontWithName:LATO_REGULAR size:26.f];

    } else if (iPhone6) {
        
        self.cityNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(12, 17, ScreenWidth - 10, 40)];
        self.cityNameLabel.text = @"San Francisco";
    ...
    self.cityNameLabel.width = ScreenWidth - 10;
    ...
    if (iPhone4_4s || iPhone5_5s) {
        ...
        self.weatherDesLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, 50, ScreenWidth - 10, 20)];
        self.weatherDesLabel.text = @"broken clouds";
        self.weatherDesLabel.font = [UIFont fontWithName:LATO_THIN size:14.f];
        
    } else if (iPhone6) {
        
        self.weatherDesLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, 62, ScreenWidth - 10, 20)];
        self.weatherDesLabel.text = @"broken clouds";
    ...
    self.weatherDesLabel.width = ScreenWidth - 10;
...
- (void)show {
    ...
    if (type == __RAIN) {
        ...
        self.weatherConditionView = [[RainView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth / 2.f, ScreenHeight - ScreenWidth - ScreenWidth / 2.f)];
        ...
        self.weatherConditionView = [[SnowView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth / 2.f, ScreenHeight - ScreenWidth - ScreenWidth / 2.f)];
