...
- (instancetype)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:CGRectMake(0, 0, ScreenWidth / 2.f, ScreenWidth / 2.f + UPDATING_HEIGHY)];
    if (self) {
        [self initLabel];
        [self initSnow];
...
- (void)initLabel {
    self.label = [[UILabel alloc] initWithFrame:CGRectMake(0, ScreenWidth / 2.f, ScreenWidth / 2.f, UPDATING_HEIGHY)];
    ...
    self.failedLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, ScreenWidth / 2.f, ScreenWidth / 2.f, UPDATING_HEIGHY)];
...
- (void)initSnow {
    self.snow = [[SnowView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth / 2.f, ScreenWidth / 2.f)];
    ...
    self.snow.layer.mask = [CALayer createMaskLayerWithSize:CGSizeMake(ScreenWidth / 2.f, ScreenWidth / 2.f)
