...
- (void)initLabels {
    ...
    UIView *dateBlackView = [[UIView alloc] initWithFrame:CGRectMake(ScreenWidth - 50, 0, 50, 12.f)];
    ...
    // 线条
    UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, ScreenWidth / 4.f - 0.5, ScreenWidth, 0.5)];
