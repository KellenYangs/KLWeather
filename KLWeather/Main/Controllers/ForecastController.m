...
- (void)initTableView {
    ...
    // cell高度
    self.cellHeight = ScreenWidth / 4.f;
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    if (section == 0) {
        ...
        ForecastWeatherView *titleView = [[ForecastWeatherView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight - ScreenWidth * 1.5)];
        [titleView buildView];
        
        titleView.cityName    = self.weatherCondition.city.name;
        titleView.countryCode = self.weatherCondition.city.country;
        
        UIView *line         = [[UIView alloc] initWithFrame:CGRectMake(0, ScreenHeight - ScreenWidth * 1.5 - 1, ScreenWidth, 0.5)];
