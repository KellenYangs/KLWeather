...
- (void)buildView {
    ...
    if (iPhone4_4s) {
        ...
        // 显示控件
        self.humidityView = [[HumidityView alloc] initWithFrame:CGRectMake(0, ScreenHeight - ScreenWidth / 2.f, ScreenWidth / 2.f, ScreenWidth / 2.f)];
        [self.humidityView buildView];
        [self.tableView addSubview:self.humidityView];
        
        
        self.sunInfoView = [[SunInfoView alloc] initWithFrame:CGRectMake(ScreenWidth / 2.f, ScreenHeight - ScreenWidth / 2.f, ScreenWidth / 2.f, ScreenWidth / 2.f)];
        [self.sunInfoView buildView];
        [self.tableView addSubview:self.sunInfoView];
        
        
        self.temperatureView = [[TemperatureView alloc] initWithFrame:CGRectMake(ScreenWidth / 2.f, ScreenHeight - ScreenWidth, ScreenWidth / 2.f, ScreenWidth / 2.f)];
        [self.temperatureView buildView];
        [self.tableView addSubview:self.temperatureView];
        
        
        self.weatherIconView = [[WeatherIconView alloc] initWithFrame:CGRectMake(0, ScreenHeight - ScreenWidth, ScreenWidth / 2.f, ScreenWidth / 2.f)];
        ...
        self.windSpeedView = [[WindSpeedView alloc] initWithFrame:CGRectMake(ScreenWidth / 2.f, ScreenHeight - ScreenWidth / 2.f, ScreenWidth / 2.f, ScreenWidth / 2.f)];
        [self.windSpeedView buildView];
        [self.tableView addSubview:self.windSpeedView];
        
        self.maxTempView = [[MaxTempView alloc] initWithFrame:CGRectMake(0, ScreenHeight - ScreenWidth / 2.f, ScreenWidth / 2.f, ScreenWidth / 2.f)];
        [self.maxTempView buildView];
        [self.tableView addSubview:self.maxTempView];
        
        self.sunInfoView = [[SunInfoView alloc] initWithFrame:CGRectMake(ScreenWidth / 2.f, ScreenHeight - ScreenWidth, ScreenWidth / 2.f, ScreenWidth / 2.f)];
        [self.sunInfoView buildView];
        [self.tableView addSubview:self.sunInfoView];
        
        self.temperatureView = [[TemperatureView alloc] initWithFrame:CGRectMake(ScreenWidth / 2.f, ScreenHeight - ScreenWidth - ScreenWidth / 2.f, ScreenWidth / 2.f, ScreenWidth / 2.f)];
        [self.temperatureView buildView];
        [self.tableView addSubview:self.temperatureView];
        
        self.weatherIconView = [[WeatherIconView alloc] initWithFrame:CGRectMake(0, ScreenHeight - ScreenWidth - ScreenWidth / 2.f, ScreenWidth / 2.f, ScreenWidth / 2.f)];
        [self.weatherIconView buildView];
        [self.tableView addSubview:self.weatherIconView];
    }
    ...
    // 创建出线条
    {
        self.grayLine1                 = [[LeftToRightView alloc] initWithFrame:CGRectMake(0, ScreenHeight - ScreenWidth / 2.f, ScreenWidth, 0.5)];
        self.grayLine1.backgroundColor = [UIColor blackColor];
        self.grayLine1.alpha           = 0.1;
        [self.tableView addSubview:self.grayLine1];
        
        self.grayLine2                 = [[LeftToRightView alloc] initWithFrame:CGRectMake(0, ScreenHeight - 1, ScreenWidth, 0.5)];
        self.grayLine2.backgroundColor = [UIColor blackColor];
        self.grayLine2.alpha           = 0.1;
        [self.tableView addSubview:self.grayLine2];
        
        self.grayLine3                 = [[LeftToRightView alloc] initWithFrame:CGRectMake(0, ScreenHeight - ScreenWidth, ScreenWidth, 0.5)];
        self.grayLine3.backgroundColor = [UIColor blackColor];
        self.grayLine3.alpha           = 0.1;
        [self.tableView addSubview:self.grayLine3];
        
        self.grayLine4                 = [[LeftToRightView alloc] initWithFrame:CGRectMake(0, ScreenHeight - ScreenWidth - ScreenWidth / 2.f, ScreenWidth, 0.5)];
        self.grayLine4.backgroundColor = [UIColor blackColor];
        self.grayLine4.alpha           = 0.1;
        [self.tableView addSubview:self.grayLine4];
        
        self.vLine                     = [[UpToDownView alloc] initWithFrame:CGRectMake(ScreenWidth / 2.f - 1, ScreenHeight - ScreenWidth - ScreenWidth / 2.f, 0.5, ScreenWidth + ScreenWidth / 2.f)];
    ...
    // 标题
    self.cityTitleView = [[CityTitleView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, ScreenHeight - ScreenWidth - ScreenWidth / 2.f)];
    ...
    self.showDownView.y = ScreenHeight + 20.f;
    ...
    // tableView上面加载的view
    self.shapeWordView           = [[ShapeWordView alloc] initWithFrame:CGRectMake(0, -60, ScreenWidth, 60)];
...
- (void)show {
    ...
    // 湿度显示
    self.humidityView.percent = self.weahterData.main.hunidity.intValue / 100.f;
