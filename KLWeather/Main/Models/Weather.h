...
@property (nonatomic, copy  ) NSString *main;       // Group of weather parameters (Rain, Snow, Extreme etc.)
@property (nonatomic, copy) NSString *icon;  // Weather icon id
@property (nonatomic, copy) NSString *descriptionInfo; // Weather condition within the group
